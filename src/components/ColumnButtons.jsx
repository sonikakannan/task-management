'use client'
export const ColumnButtons = ({ handleMove, column }) => {
  return (
    <div className="flex flex-col z-10 absolute  right-8 top-2 text-xs border rounded bg-neutral-800 border-neutral-700">
      {column !== "backlog" && (
        <button
          onClick={() => handleMove("backlog")}
          className={`border-red-800/80 bg-red-100/20 text-red-500/80
